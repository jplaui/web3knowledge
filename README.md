...
- [Secure computation: Homomorphic encryption or hardware enclaves?](https://medium.com/mc2-project/secure-computation-homomorphic-encryption-or-hardware-enclaves-83da90102593)
- [BLS12-381 For The Rest Of Us](https://hackmd.io/@benjaminion/bls12-381)
- [zkSNARKs in a nutshell](https://blog.ethereum.org/2016/12/05/zksnarks-in-a-nutshell/)
- [A Brief Dive Into zk-SNARKs and the ZoKrates Toolbox on the Ethereum Blockchain](https://medium.com/cornellblockchain/a-brief-dive-into-zk-snarks-and-the-zokrates-toolbox-on-the-ethereum-blockchain-cb7bd7f00fdc)
...
- [Demystifying Zero Knowledge Proofs](https://docs.google.com/presentation/d/1gfB6WZMvM9mmDKofFibIgsyYShdf0RV_Y8TLz3k1Ls0/edit#slide=id.g443f641f0b_1_338)
...
- [Simple Explanations of Arithmetic Circuits and Zero-Knowledge Proofs](https://medium.com/web3studio/simple-explanations-of-arithmetic-circuits-and-zero-knowledge-proofs-806e59a79785)
- [Blockchains, crypto, & web3: Connections, models, more](https://a16z.simplecast.com/episodes/blockchains-crypto-web3-connections-models-QRYQ9oIi), [all episodes](https://a16z.simplecast.com/episodes)
- [Web3 is Self-Certifying](https://jaygraber.medium.com/web3-is-self-certifying-9dad77fd8d81)
- [Web5: The Decentralized Web Platform](https://developer.tbd.website/docs/Decentralized%20Web%20Platform%20-%20Public.pdf)
- [What is Web5, Jack Dorsey’s latest idea?](https://medium.com/geekculture/what-is-web5-jack-dorseys-latest-idea-d40d3a2e4973)
- [ZKP— PlonK Algorithm Introduction](https://trapdoortech.medium.com/zkp-plonk-algorithm-introduction-834556a32a)
- [Create your first zero-knowledge snark circuit using circom and snarkjs](https://blog.iden3.io/first-zk-proof.html)
- [iden3 Blog](https://blog.iden3.io/)
- [The BBS Signature Scheme](https://identity.foundation/bbs-signature/draft-looker-cfrg-bbs-signatures.html)
...
- [tutorial anoncreds](https://docknetwork.github.io/sdk/tutorials/tutorial_anoncreds.html)
- [Medium: Arthur Hayes](https://cryptohayes.medium.com/)
...
- [ZK-STARK Theory & Implementation](https://berkeley-desys.github.io/assets/material/lec5_eli_ben_sasson_zk_stark.pdf)
- [Proofs, Arguments, and Zero-Knowledge](https://people.cs.georgetown.edu/jthaler/ProofsArgsAndZK.html), [PDF](https://people.cs.georgetown.edu/jthaler/ProofsArgsAndZK.pdf), [Youtube](https://www.youtube.com/watch?v=esBIB_ZaFVg&list=PLj80z0cJm8QEmZkGgSOLpr_8B08SCWVQ7)
- [CSN09112 Module](https://github.com/billbuchanan/csn09112), [Example file encryption using scrypt and NaCl for the gocrypto book](https://github.com/billbuchanan/filecrypt)
- [ECE/CS 598 AM: Cryptography with Ideal Functionalities](https://decentralize.ece.illinois.edu/ece-cs-598-am-cryptography-with-ideal-functionalities/)
- [Einführung in die Kryptographie von Christof Paar](https://www.youtube.com/channel/UCuJu8DOJLMltMt8RcX1tdBw/videos)
- [Decentralized Systems Lab](https://decentralize.ece.illinois.edu/)
- [Zero-Knowledge Proofs](https://zkp.science/)
- [Lecture slides Blockchain-based Systems Engineering](https://github.com/sebischair/bbse)
- [Iden3 Documentation: Publications](https://docs.iden3.io/publications/publications/)
- [Onur Mutlu: Digital Design and Computer Architecture Spring 2020 (252-0028-00L)](https://safari.ethz.ch/digitaltechnik/spring2020/doku.php?id=start)
- [Onur Mutlu: Lecture Video Playlist on YouTube](https://safari.ethz.ch/digitaltechnik/spring2019/doku.php?id=schedule)
- [Andrew Miller: ECE498AC/CS498AM: Applied Cryptography, Fall 2019](https://soc1024.ece.illinois.edu/teaching/ece498ac/fall2019/)
- [Decentralized Systems Lab: Courses](https://decentralize.ece.illinois.edu/courses/)
- [Christine Parlour, Dawn Song: CS294-177/CS194-177/PHDBA 297T.1/MFE 230T.3: Decentralized Finance](https://berkeley-defi.github.io/f21)
- [Intuitive Advanced Cryptography](https://raw.githubusercontent.com/cryptosubtlety/intuitive-advanced-cryptography/master/advancedcrypto.pdf)
- [A Graduate Course in Applied Cryptography](https://crypto.stanford.edu/~dabo/cryptobook/BonehShoup_0_5.pdf)

#### Youtube Channels

- [IC3 Initiative for Cryptocurrencies and Contracts](https://www.youtube.com/channel/UCz-eTbD4kHkYxGhUfXawHow)
...
- [Youtube: Discrete Log based Zero-Knowledge Proofs - Dan Boneh, Stanford](https://www.youtube.com/watch?v=wB3DlND7KEw)
- [ZKProof Community Reference](https://docs.zkproof.org/pages/reference/reference.pdf)
- [Lecture 5: Proofs of Knowledge, Schnorr’s protocol, NIZK](https://crypto.stanford.edu/cs355/19sp/lec5.pdf)
- [Doubly-efficient zkSNARKs without trusted setup](https://eprint.iacr.org/2017/1132.pdf)
- [zkStudyClub: PCD without zkSNARK with Pratyush Mishra (UC Berkeley) & Benedikt Bünz (Stanford)](https://www.youtube.com/watch?v=TRyep--q6jU)
- [Designated Verifier Proofs and Their Applications](https://link.springer.com/content/pdf/10.1007/3-540-68339-9_13.pdf)
- [Mystique: Efficient Conversions for Zero-Knowledge Proofs with Applications to Machine Learning](https://www.usenix.org/system/files/sec21-weng.pdf)
...
- [Verifiable Delay Functions](https://link.springer.com/chapter/10.1007/978-3-319-96884-1_25)

#### Zero-Knowledge Proxy

- [Zero-Knowledge Middleboxes](https://eprint.iacr.org/2021/1022.pdf)
- [Blind Certificate Authorities](https://par.nsf.gov/servlets/purl/10163755)
...
- [NEXTLEAP: Decentralizing Identity with Privacy for Secure Messaging](https://hal.inria.fr/hal-01673292/file/ares2017.pdf)
- [Compact Certificates of Collective Knowledge](http://people.csail.mit.edu/nickolai/papers/micali-compactcert.pdf)
- [CA Authorization Smart Contract Architecture](https://files.slack.com/files-pri/T02467QPZ5G-F03BK93D59T/image.png)
- [On Enforcing the Digital Immunity of a Large Humanitarian Organization](https://discovery.ucl.ac.uk/id/eprint/10116630/1/Jovanovic_digital-immunity.pdf)
- [Anonymity, Unlinkability, Unobservability, Pseudonymity, and Identity Management – A Consolidated Proposal for Terminology](https://citeseerx.ist.psu.edu/viewdoc/download?doi=10.1.1.154.421&rep=rep1&type=pdf)
- [Security Analysis of Coconut, an Attribute-Based Credential Scheme with Threshold Issuance](https://eprint.iacr.org/2022/011.pdf)
- [Zero-Knowledge Proof-of-Identity: Sybil-Resistant, Anonymous Authentication on Permissionless Blockchains and Incentive Compatible, Strictly Dominant Cryptocurrencies](https://arxiv.org/pdf/1905.09093.pdf)
- [Towards Self-sovereign, Decentralized Personal Data Sharing and Identity Management](https://mediatum.ub.tum.de/doc/1545514/1545514.pdf)
- [Auditable Credential Anonymity Revocation Based on Privacy-Preserving Smart Contracts](https://arxiv.org/pdf/1908.02443.pdf%20)
- [Anonymous Credentials Light](https://cs.brown.edu/people/fbaldimt/papers/CCS13.pdf)
- [SCPKI: A Smart Contract-based PKI and Identity System](http://library.usc.edu.ph/ACM/SIGSAC%202017/bcc/p35.pdf)
- [Cinderella: Turning Shabby X.509 Certificates into Elegant Anonymous Credentials with the Magic of Verifiable Computation](http://www.contrib.andrew.cmu.edu/~bparno/papers/cinderella.pdf)
- [With a Little Help from My Friends: Constructing Practical Anonymous Credentials](https://eprint.iacr.org/2021/1419.pdf)
- [Towards Smart Contract-based Verification of Anonymous Credentials](https://eprint.iacr.org/2022/492.pdf)
- [Exploring Web3 From the View of Blockchain](https://arxiv.org/pdf/2206.08821.pdf)
- [zk-creds: Flexible Anonymous Credentials from zkSNARKs and Existing Identity Infrastructure](https://eprint.iacr.org/2022/878.pdf)
- [Decentralized Anonymous Credentials](https://eprint.iacr.org/2013/622.pdf)
- [A note on anonymous credentials using BLS signatures](https://arxiv.org/pdf/2006.05201.pdf)
...
- [Anonymous credentials 2.0](https://wiki.hyperledger.org/download/attachments/6426712/Anoncreds2.1.pdf)
...
- [A Survey on Authorization in Distributed Systems: Information Storage, Data Retrieval and Trust Evaluation](https://ieeexplore.ieee.org/abstract/document/8029549/)
...
- [Chainlink Off-chain Reporting Protocol](https://research.chain.link/ocr.pdf)
- [Town Crier: An Authenticated Data Feed for Smart Contracts](https://dl.acm.org/doi/pdf/10.1145/2976749.2978326)
- [DECO: Liberating Web Data Using Decentralized Oracles for TLS](https://dl.acm.org/doi/pdf/10.1145/3372297.3417239)
- [Practical Decentralized Oracle Contracts for Cryptocurrencies](https://eprint.iacr.org/2022/499.pdf)
- [Discreet Log Contracts](https://adiabat.github.io/dlc.pdf)
- [Youtube: Fan Zhang- "Connection Blockchains to the Real World"](https://www.youtube.com/watch?v=LWphxmUWXG0)
...
- [Towards Extending Noiseless Privacy - Dependent Data and More Practical Approach](https://arxiv.org/pdf/1605.07956.pdf)

#### Oblivious Random Access Machine (ORAM)

- [MACAO: A Maliciously-Secure and Client-Efficient Active ORAM Framework](https://par.nsf.gov/servlets/purl/10205591)
- [A Tale of Two Trees: One Writes, and Other Reads](https://par.nsf.gov/servlets/purl/10200542)

#### Confidential Access Control Policies

- [Ciphertext policy Attribute based Encryption with anonymous access policy](https://arxiv.org/pdf/1011.0527.pdf)
...
- [TimeCrypt: Encrypted Data Stream Processing at Scale with Cryptographic Access Control](https://www.usenix.org/system/files/nsdi20-paper-burkhalter.pdf)

#### Short-lived access control

- [Abuse Resistant Law Enforcement Access Systems](https://eprint.iacr.org/2021/321.pdf)

#### Decentralized access control

- [CALYPSO: Private Data Management for Decentralized Ledgers](https://eprint.iacr.org/2018/209.pdf)
- [Droplet: Decentralized Authorization and Access Control for Encrypted Data Streams](https://www.usenix.org/system/files/sec20-shafagh.pdf)
- [Witness Encryption and its Applications](https://eprint.iacr.org/2013/258.pdf)
- [LedgerView: Access-Control Views on Hyperledger Fabric](https://www.comp.nus.edu.sg/~ooibc/BlockchainView.pdf)
- [WAVE: A Decentralized Authorization Framework with Transitive Delegation](https://www.usenix.org/system/files/sec19-andersen.pdf)
- [Decentralizing Privacy: Using Blockchain to Protect Personal Data](http://homepage.cs.uiowa.edu/~ghosh/blockchain.pdf)
- [Design of a Privacy-Preserving Decentralized File Storage with Financial Incentives](https://ieeexplore.ieee.org/abstract/document/7966965)
- [Controlling Access to an Oblivious Database Using Stateful Anonymous Credentials](https://link.springer.com/content/pdf/10.1007/978-3-642-00468-1_28.pdf)
...
- [Building a Secure Data Market on Blockchain](https://www.usenix.org/conference/enigma2019/presentation/song), [Youtube](https://www.youtube.com/watch?v=xF50qCIYwpQ)
- [Zeph: Cryptographic Enforcement of End-to-End Data Privacy](https://www.usenix.org/system/files/osdi21-burkhalter.pdf)
- [A Demonstration of Sterling: A Privacy-Preserving Data Marketplace](https://www.raymondcheng.net/download/papers/sterling-vldb.pdf)
- [Towards Building a Responsible Data Economy (Dawn Song, UC Berkeley)](https://speakerdeck.com/anyscale/towards-building-a-responsible-data-economy-dawn-song-uc-berkeley?slide=53), [Youtube](https://www.youtube.com/watch?v=nBzufVswN1g)
...
- [FileBounty: Fair Data Exchange](https://arxiv.org/pdf/2008.11362.pdf)
- [Do You Know Where Your Data Are? Secure Data Capsules for Deployable Data Protection](https://www.usenix.org/legacy/events/hotos11/tech/final_files/ManiatisAkhawe.pdf)
- [Towards Blockchain-based Auditable Storage and Sharing of IoT Data](https://arxiv.org/pdf/1705.08230.pdf)
- [Universal Atomic Swaps: Secure Exchange of Coins Across All Blockchains](https://eprint.iacr.org/2021/1612.pdf)
- [NFTs for Art and Collectables: Primer and Outlook](https://files.osf.io/v1/resources/gwzd7/providers/osfstorage/628cfa67be4dfd076a66dcb8?action=download&direct&version=1)

#### Decentralized Storage

- [IPFS - Content Addressed, Versioned, P2P File System (DRAFT 3)](https://arxiv.org/pdf/1407.3561.pdf)
- [Topology-Aware Cooperative Data Protection in Blockchain-Based Decentralized Storage Networks](https://arxiv.org/pdf/2001.04526.pdf)
- [Secure Untrusted Data Repository (SUNDR)](https://www.usenix.org/legacy/event/osdi04/tech/full_papers/li_j/li_j.pdf)
- [DORY: An Encrypted Search System with Distributed Trust](https://www.usenix.org/system/files/osdi20-dauterman_dory.pdf)
- [Verifiable Set Operations over Outsourced Databases](https://link.springer.com/content/pdf/10.1007/978-3-642-54631-0_7.pdf)
- [When Query Authentication Meets Fine-Grained Access Control: A Zero-Knowledge Approach](http://www.comp.hkbu.edu.hk/~xujl/Papers/sigmod18_auth.pdf)
- [vSQL: Verifying Arbitrary SQL Queries over Dynamic Outsourced Databases](https://eprint.iacr.org/2017/1145.pdf)

#### Decentralized Secret Management

- [Can a Public Blockchain Keep a Secret?](https://eprint.iacr.org/2020/464.pdf)
- [CHURP: Dynamic-Committee Proactive Secret Sharing](https://dl.acm.org/doi/pdf/10.1145/3319535.3363203)
- [Storing and Retrieving Secrets on a Blockchain](https://eprint.iacr.org/2020/504.pdf)
- [Practical Non-interactive Publicly Verifiable Secret Sharing with Thousands of Parties](https://eprint.iacr.org/2021/1397.pdf)
- [Refresh When You Wake Up: Proactive Threshold Wallets with Offline Devices](https://eprint.iacr.org/2019/1328.pdf)
- [Long Live The Honey Badger: Robust Asynchronous DPSS and its Applications](https://eprint.iacr.org/2022/971.pdf)
- [COBRA: Dynamic Proactive Secret Sharing for Confidential BFT Services](http://www.di.fc.ul.pt/~blferreira/papers/COBRA.pdf)
- [Smart Contract With Secret Parameters](https://infoscience.epfl.ch/record/277810)

#### Asset privacy, transfers, attestation, and delegation

- [Espresso CAP Specification: Configurable Asset Privacy](https://raw.githubusercontent.com/EspressoSystems/cap/main/cap-specification.pdf)
- [Decentralized Cross-Blockchain Asset Transfers](https://arxiv.org/pdf/2004.10488.pdf)
...
- [NuCypher KMS: Decentralized key management system](https://arxiv.org/pdf/1707.06140.pdf)

#### Cryptoeconomic Security

- [Cryptoeconomic Security for Data Availability Committees](https://arxiv.org/pdf/2208.02999.pdf)
- [Balance: Dynamic Adjustment of Cryptocurrency Deposits](https://dl.acm.org/doi/pdf/10.1145/3319535.3354221)

#### Decentralized computation

- [Hawk: The Blockchain Model of Cryptography and Privacy-Preserving Smart Contracts](https://eprint.iacr.org/2015/675.pdf)
- [VERI-ZEXE: Decentralized Private Computation with Universal Setup](https://eprint.iacr.org/2022/802.pdf)
- [On-Chain Fully Homomorphic Encryption: smartFHE: Privacy-Preserving Smart Contracts from Fully Homomorphic Encryption](https://eprint.iacr.org/2021/133.pdf)
- [Zexe: Enabling Decentralized Private Computation](https://eprint.iacr.org/2018/962.pdf)
- [Zexe Youtube](https://www.youtube.com/watch?v=aqkzV81sLmQ&t=5s)
...
- [HoneyBadgerMPC and AsynchroMix: Practical Asynchronous MPC and its Application to Anonymous Communication](https://dl.acm.org/doi/pdf/10.1145/3319535.3354238)
- [Enigma: Decentralized Computation Platform with Guaranteed Privacy](https://arxiv.org/pdf/1506.03471.pdf)
...
- [Decentralized Privacy-preserving Timed Execution in Blockchain-based Smart Contract Platforms](https://arxiv.org/pdf/1902.05613.pdf)
...
- [ACE: Asynchronous and Concurrent Execution of Complex Smart Contracts](https://dl.acm.org/doi/pdf/10.1145/3372297.3417243)
- [Piranha: A GPU Platform for Secure Computation](https://eprint.iacr.org/2022/892.pdf)
- [CLOAK: Enabling Confidential Smart Contract with Multi-party Transactions](https://arxiv.org/pdf/2106.13926.pdf)
- [Scalable and Privacy-preserving Off-chain Computations](https://www.depositonce.tu-berlin.de/bitstream/11303/13087/4/eberhardt_jacob.pdf)
- [Auditable, Available and Resilient Private Computation on the Blockchain via MPC](https://eprint.iacr.org/2022/398.pdf)
...
- [Faster Secure Two-Party Computation in the Single-Execution Setting](https://eprint.iacr.org/2016/762.pdf)
- [Computing on Encrypted Data](https://homes.esat.kuleuven.be/~nsmart/FHE-MPC/Yao.pdf)
- [Publicly Auditable MPC-as-a-Service with succinct verification and universal setup](https://arxiv.org/pdf/2107.04248.pdf)
- [Multiverse of HawkNess: A Universally-Composable MPC-based Hawk Variant](https://eprint.iacr.org/2022/421.pdf)
- [Efficient Constant-Round MPC with Identifiable Abort and Public Verifiability](https://eprint.iacr.org/2020/767.pdf)
- [MPC-TP: Fully Linear PCPs and their Cryptographic Applications - Niv Gilboa](https://www.youtube.com/watch?v=ognJEChMyrk)
- [Founding Secure Computation on Blockchains](https://eprint.iacr.org/2019/253.pdf)

#### Systematizations of Knowledge

- [SoK: Off The Chain Transactions](https://nms.kcl.ac.uk/patrick.mccorry/SoKoffchain.pdf)
- [Formalizing Anonymous Blacklisting Systems](https://oaklandsok.github.io/papers/henry2011.pdf)
...
- [SoK: Off The Chain Transactions](https://nms.kcl.ac.uk/patrick.mccorry/SoKoffchain.pdf)
- [SoK: Certified Robustness for Deep Neural Networks](https://sokcertifiedrobustness.github.io/)
- [SoK: Computer-Aided Cryptography](https://oaklandsok.github.io/papers/barbosa2021.pdf)
- [SoK: Blockchain Light Clients](https://eprint.iacr.org/2021/1657.pdf)
- [SoK: General Purpose Compilers for Secure Multi-Party Computation](https://www.cis.upenn.edu/~stevez/papers/HHNZ19.pdf)
- [SoK: TEE-assisted Confidential Smart Contract](https://arxiv.org/pdf/2203.08548.pdf)
- [SoK: Differential Privacy as a Causal Property](https://oaklandsok.github.io/papers/tschantz2020.pdf)
...
- [SoK: Delegation and Revocation, the Missing Links in the Web’s Chain of Trust](https://oaklandsok.github.io/papers/chuat2020.pdf)
- [SoK: Oracles from the Ground Truth to Market Manipulation](https://arxiv.org/pdf/2106.00667.pdf)
- [SoK: Benchmarking Flaws in Systems Security](https://arxiv.org/pdf/1801.02381.pdf)
...
- [Quisquis: A New Design for Anonymous Cryptocurrencies](https://discovery.ucl.ac.uk/id/eprint/10090371/1/asiacrypt-main.pdf)

#### Wallets

- [A Formal Treatment of Hardware Wallets](https://eprint.iacr.org/2019/034.pdf)
- [On the Usability of Authenticity Checks for Hardware Security Tokens](https://www.usenix.org/system/files/sec21-pfeffer.pdf)
...
- [A Blockchain Model in Tamarin and Formal Analysis of Hash Time Lock Contract](https://drops.dagstuhl.de/opus/volltexte/2020/13418/pdf/OASIcs-FMBC-2020-5.pdf)
- [Zapper: Smart Contracts with Data and Identity Privacy](https://files.sri.inf.ethz.ch/website/papers/ccs22-zapper.pdf)
...
- [Benchmarking Crimes: An Emerging Threat in Systems Security](https://arxiv.org/pdf/1801.02381.pdf)
...
- [An ACME-based certificate authority, written in Go](https://github.com/letsencrypt/boulder)
- [ENS](https://docs.ens.domains/)
- [Ethereum Name Service: the Good, the Bad, and the Ugly](https://arxiv.org/pdf/2104.05185.pdf?ref=https://githubhelp.com)
- [Asecuritysite: DNSSEC](https://asecuritysite.com/encryption/go_dnssec)

#### Storage

- [Smart contracts + provable storage = FVM](https://fvm.filecoin.io/)
- [Decentralized Web Node](https://identity.foundation/decentralized-web-node/spec/#abstract)
- [Decentralized Web Node (DWN) SDK](https://developer.tbd.website/projects/dwn-sdk-js/readme/)

#### Data

- [Atlan: The new way for data-driven teams to discover, understand, trust, and collaborate on data assets](https://atlan.com/)
- [Promethium: Fast Data Discovery and Governance](https://www.pm61data.com/)
- [Steem: Powering Communities and Opportunities](https://steem.com/)
- [Affinidi: Changing data ownership for good](https://www.affinidi.com/)
- [Veramo: Performant and modular APIs for Verifiable Data and SSI](https://veramo.io/)
...
- [libocr consists of a Go library and a set of Solidity smart contracts that implement the Chainlink Offchain Reporting Protocol](https://github.com/smartcontractkit/libocr)
- [This demonstrates how a smart contract on NEAR can access off-chain data via Chainlink's oracle solution.](https://github.com/near-examples/chainlink-demo)

#### Resolution

- [The industry leading Web3 API](https://www.alchemy.com/supernode)
- [The World’s Most Powerful Blockchain Development Suite](https://infura.io/)
- [Composable Web3 data network](https://ceramic.network/)
- [Sign-in with Ethereum RFP](https://notes.ethereum.org/@djrtwo/sign-in-with-ethereum-RFP)
- [Ceramic Protocol Specification](https://github.com/ceramicnetwork/ceramic/blob/main/SPECIFICATION.md#looking-up-a-stream)
...
- [Golang SSI Framework](https://github.com/TBD54566975/ssi-sdk)
- [NFT3 | The First Unified Virtual Identity Network for Web3](https://www.nft3.com/)
- [The essential web3 toolkit for sharing and funding anything.](https://mirror.xyz/)
- [Identity protocol for open applications](https://idx.xyz/)
- [Polygon DID Implementation](https://docs.polygon.technology/docs/develop/did-implementation/getting-started/)
- [Introducing Polygon ID, Zero-Knowledge Identity for Web3](https://blog.polygon.technology/introducing-polygon-id-zero-knowledge-own-your-identity-for-web3/)
- [EIP-1056: Ethereum Lightweight Identity](https://eips.ethereum.org/EIPS/eip-1056)
- [Claim your passport](https://arcx.game/passport)
- [decentralized-identity / snark-credentials](https://github.com/decentralized-identity/snark-credentials/blob/master/whitepaper.pdf)
- [spruceID: Your Keys, Your Data](https://www.spruceid.com/), [github](https://github.com/spruceid)
- [iden3: Prove your access rights, not your identity](https://iden3.io/)
- [emmy: Library for zero-knowledge proof based applications (like anonymous credentials](https://github.com/xlab-si/emmy)

#### ZKPs

- [Starkware STARK 101](https://starkware.co/stark-101/)
- [zkSync is a user-centric zk rollup platform from Matter Labs (opens new window). It is a scaling solution for Ethereum, already live on Ethereum mainnet.](https://docs.zksync.io/userdocs/)
- [zkSNARK implementation in JavaScript & WASM](https://github.com/iden3/snarkjs)
- [ZoKrates](https://zokrates.github.io/)
- [arkworks is a Rust ecosystem for zkSNARK programming](https://github.com/arkworks-rs)
...
- [zkSNARK library implementation in Go from scratch (compiler, setup, prover, verifier)](https://github.com/arnaucube/go-snark-study)
- [circom and snarkjs](https://cs251.stanford.edu/hw/proj4.pdf)
- [zkSnark circuit compiler](https://github.com/iden3/circom)
- [zkSNARK implementation in JavaScript & WASM](https://github.com/iden3/snarkjs)
- [Circom circuits used by the iden3 core protocol.](https://github.com/iden3/circuits)
- [zkrp package](https://pkg.go.dev/github.com/0xdecaf/zkrp#section-readme)
- [Ethereum implementation of the Coconut smart contract library](https://github.com/musalbas/coconut-ethereum)
- [MerkleTree compatible with circomlib/sm](https://github.com/iden3/go-merkletree)
...
- [dpss python](https://github.com/tyurek/dpss)

#### Decentralized and Secure Computation

- [Robust MPC-based confidentiality layer for blockchains](https://github.com/initc3/HoneyBadgerMPC)
- [Anonymous Zether: A private payment system for Ethereum-based blockchains, with no trusted setup.](https://github.com/ConsenSys/anonymous-zether)
- [emp-toolkit](https://github.com/emp-toolkit)
- [ABY Developer Guide](https://www.informatik.tu-darmstadt.de/media/encrypto/encrypto_code/abydevguide.pdf)
- [The Confidential Computing Platform for Collaborative Analytics and AI](https://opaque.co/)
...
- [Hyperledger CL Credentials](https://github.com/hyperledger/ursa-docs/blob/main/docs/features/attribute_equality_anoncreds.md)
- [Hyperledger BBS+ Credentials](https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&ved=2ahUKEwjprZizn-n5AhWcXvEDHRjMCdAQFnoECAYQAQ&url=https%3A%2F%2Fwiki.hyperledger.org%2Fdownload%2Fattachments%2F6426712%2FAnoncreds2.1.pdf&usg=AOvVaw2B-a7JFWfJ1LVFOidVWVhD), [PDF Title: Anonymous credentials 2.0](Anoncreds2.1-3.pdf)
- [Veramo](https://veramo.io/), [docs](https://veramo.io/docs/basics/introduction/), [specs](https://github.com/uport-project/specs)
- [SpruceID](https://www.spruceid.com/), [docs](https://www.spruceid.dev/), [cryptoscript](https://github.com/spruceid/cryptoscript)
- [iden3](https://iden3.io/), [docs](https://docs.iden3.io/)
- [Mattr](https://mattr.global/), [docs](https://github.com/mattrglobal), [learn](https://learn.mattr.global/docs/concepts/digital-identity)
- [Trinsic](https://trinsic.id/), [docs](https://docs.trinsic.id/docs/introduction)
- [Lukso](https://lukso.network/), [docs](https://docs.lukso.tech/)
- [Ceramic](https://ceramic.network/), [docs](https://developers.ceramic.network/docs/advanced/standards/application-protocols/identity-index/)
- [Ocean Protocol](https://oceanprotocol.com/), [docs](https://github.com/oceanprotocol/docs)
- [Secret Network](https://scrt.network/), [docs](https://docs.scrt.network/secret-network-documentation/)
- [Oasis Labs](https://www.oasislabs.com/), [docs](https://docs.oasislabs.com/parcel/latest/quickstart/getting-started.html)
- [iExec](https://iex.ec/), [docs](https://docs.iex.ec/)
- [Sia](https://siawiki.tech/)
...
- [civic](https://www.civic.com/), [docs](https://docs.civic.com/)
- [Decentralized Identity Foundation](https://identity.foundation/), [docs](https://github.com/decentralized-identity)
- [ShoCard](https://www.shocard.com/en.html), [docs](https://www.shocard.com/en/developer.html)
- [Phala](https://www.phala.network/en/), [docs](https://wiki.phala.network/en-us/build/developer/intro/)
- [iDX](https://idx.xyz/), [docs](https://developers.idx.xyz/learn/welcome/)
- [Serto](https://www.serto.id/), [docs](https://docs.serto.id/docs/intro)
...
- [Go Ethereum Development](https://geth.ethereum.org/)
- [ether.js: Complete Ethereum library and wallet implementation in JavaScript](https://github.com/ethers-io/ethers.js)
- [ethr-did-resolver: DID resolver for Ethereum Addresses with support for key management](https://github.com/decentralized-identity/ethr-did-resolver)
- [go ethereum client](https://goethereumbook.org/en/client-setup/)
...
- [How To Use AccessControl.sol](https://medium.com/coinmonks/how-to-use-accesscontrol-sol-9ea3a57f4b15)
...
- [Creating Zero knowledge Proofs with ZoKrates](https://www.youtube.com/watch?v=_ZvGZxhCFfE)

#### Cryptographic Libraries

- [RELIC](https://github.com/relic-toolkit/relic)
- [ark-crypto-primitives](https://github.com/arkworks-rs/crypto-primitives)

---

## Conferences

- [CESC: Crypto Economics Security Conference](https://cesc.io/)
- [ICBC: IEEE International Conference on Blockchain and Cryptocurrency](https://icbc2023.ieee-icbc.org/authors/call-papers)
- [CAAW: 1st International Workshop on Cryptoasset Analytics](https://caaw.io/)
- [Cryptography Conferences](https://waset.org/cryptography-conferences)
- [IEEE-Security](https://www.ieee-security.org/)
...
- [Crypto](https://www.iacr.org/conferences/)
- [S&P: IEEE Symposium on Security and Privacy](https://www.ieee-security.org/TC/SP-Index.html)
- [NDSS Symposium](https://www.ndss-symposium.org/)
- [Security Conference Ranking](https://people.engr.tamu.edu/guofei/sec_conf_stat.htm)
- [CCS (sigsag): ACM Conference on Computer and Communications Security](https://www.sigsac.org/ccs.html)
...
- [Dawn Song](https://scholar.google.com/citations?hl=en&user=84WzBlYAAAAJ)
- [Andrew Miller](https://scholar.google.com/citations?hl=en&user=Nv2jil0AAAAJ)
- [Thomas Ristenpart](https://scholar.google.com/citations?user=MGVrVSIAAAAJ&hl=en)
- [Dan Boneh](https://scholar.google.com/citations?user=MwLqCs4AAAAJ&hl=en&oi=ao)
- [Bryan Ford](https://scholar.google.com/citations?hl=en&user=TwyzQP4AAAAJ)
- [Clementine Gritti](https://scholar.google.com/citations?user=y-Ka2XsAAAAJ&hl=en&oi=sra)
- [Andrew Paverd](https://scholar.google.com/citations?hl=en&user=QZ2HOkMAAAAJ)
- [Robert Drost, Ph.D.](https://www.linkedin.com/in/rjdrost/?original_referer=)
...
- [Asset management for a DeFi world](https://www.tokensets.com/)
- [Institutional crypto-capital network](https://www.maple.finance/)
- [Data DAO part 1 DataDAO introduction](https://www.youtube.com/watch?v=8YuagajvFJ0&t=2s)

### APIs & Tooling

- [Plain API Reference](https://plaid.com/docs/api/)
...
- [Tezos: A blockchain designed to evolve.](https://tezos.com/#news)
- [Web 5: TBD](https://developer.tbd.website/)
- [Ocean: On-ramp and off-ramp for data assets into DeFi](https://oceanprotocol.com/technology/data-nfts-and-data-tokens)
- [IC3 Newsletter.](https://myemail.constantcontact.com/IC3-Blockchain-Camp-Details-and-News.html?soid=1126638416463&aid=Mhix7NUji-U)
...
- [Encrypted Data Vaults 0.1](https://digitalbazaar.github.io/encrypted-data-vaults/#why-do-we-need-encrypted-data-vaults)
- [Decentralized Identifier Resolution (DID Resolution) v0.2](https://w3c-ccg.github.io/did-resolution/#resolver-architectures-proxied)
- [A Primer for Decentralized Identifiers](https://w3c-ccg.github.io/did-primer/)
- [Verifiable Credentials Data Model v1.1](https://www.w3.org/TR/vc-data-model/)
- [3ID DID Method Specification](https://github.com/ceramicnetwork/CIP/blob/main/CIPs/CIP-79/CIP-79.md#example-2)
- [ERC1238: Non-transferrable Non-Fungible Tokens (NTT)](https://github.com/ethereum/EIPs/issues/1238)
- [EIP-721: Non-Fungible Token Standard](https://eips.ethereum.org/EIPS/eip-721)
- [ERC-725 - Ethereum Identity Standard](https://docs.ethhub.io/built-on-ethereum/identity/ERC725/)
- [ERC-735: Claim Holder #735](https://github.com/ethereum/eips/issues/735)
...
- [Blockchain Identity](https://decentralized-id.com/blockchain/)
